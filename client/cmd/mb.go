...
to quickly create a Cobra application.`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		req, err := getRequestWithCredentials(http.MethodPost, "mb", aliasName, jsonBody)
		if err != nil {
...
func init() {
	...
	mbCmd.Flags().String("aliasName", "", "Alias name")
	mbCmd.Flags().String("bucketName", "", "Bucket name")
}
